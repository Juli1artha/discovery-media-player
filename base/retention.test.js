...
describe.skipIf(skip)("rétention : le déclaré et les survivantes", () => {
  ...
  beforeAll(async () => {
    ...
    await base.request("doc_bot_sessions", { method: "POST", headers: { Prefer: "return=minimal" }, body: [
      { session_id: "ret-b-vieille", doc_id: "ret-doc", last_at: IL_Y_A(14), created_at: IL_Y_A(14) },
      { session_id: "ret-b-fraiche", doc_id: "ret-doc", last_at: RECENT, created_at: RECENT },
    ] });

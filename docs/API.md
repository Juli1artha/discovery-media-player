...
the next release both session readings returned the row as stored. What ships now is: identifiers
...
⚠️ **What a repository layer would and would not buy.** Moving those 64 sites behind ~25 named
